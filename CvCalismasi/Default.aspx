<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvCalismasi.Default" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Suat Dirav</a></h1>
            <p class="top_hdp mt-2">Bilişim Uzmanı</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
        ...
        <div class="banner-text-w3ls" id="home">
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about" role="button">Okumaya Devam Et</a>
                </div>
            </div>
        </div>
        <!-- about -->
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" placeholder="Mesaj.." TextMode="MultiLine"></asp:TextBox>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Gönder" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-dark" Text="Temizle" OnClick="Button2_Click" />
